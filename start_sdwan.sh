...
$CTRL_EXEC /usr/local/bin/ryu-manager --observe-links ryu.app.rest_conf_switch ryu.app.ofctl_rest ryu.app.rest_qos qos_simple_switch_13.py 2>&1 | tee logs/ryu.log &
...
$CPE_EXEC ovs-vsctl set bridge brwan other-config:datapath-id=0000000000000004
...
$WAN_EXEC ovs-vsctl set bridge brwan other-config:datapath-id=0000000000000002
